...
export const MessageMenuItem = styled.button`
  display: flex;
  align-items: center;
  gap: 8px;
  width: fit-content;
...
export const MessageEditTextarea = styled.textarea`
  width: 100%;
  max-width: 600px;
  min-height: 80px;
  padding: 12px 16px;
...
export const MessageEditButtons = styled.div`
  display: flex;
  gap: 8px;
  margin-top: 8px;
`

export const MessageEditButton = styled.button<{ variant?: 'primary' | 'secondary' }>`
  padding: 6px 12px;
  border-radius: 4px;
  font-size: 12px;
  font-weight: 500;
