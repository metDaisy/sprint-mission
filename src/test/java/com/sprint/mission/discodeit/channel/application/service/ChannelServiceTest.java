...
class ChannelServiceTest {
  ...
  @Spy
  private ChannelMapper mapper = MapperContainer.get(ChannelMapper.class);
  ...
  void createPublic_success() {
    ...
    ChannelResponse result = channelService.createPublic(request);
  ...
  void createPrivate_success() {
    ...
    ChannelResponse result = channelService.createPrivate(request);
  ...
  void find_success() {
    ...
    given(repository.findChannelDetailById(id)).willReturn(Optional.of(dto));

    ChannelResponse result = channelService.find(id);
  ...
  void find_fail_notFound() {
    UUID id = UUID.randomUUID();
    given(repository.findChannelDetailById(id)).willReturn(Optional.empty());
  ...
  void findAllByUserId_success() {
    ...
    given(repository.findVisibleChannelDetails(userId)).willReturn(List.of(dto));
  ...
  void update_success() {
    ...
    assertThat(result.description()).isEqualTo("UpdatedDesc");
  }
