...
public class ServiceLoggingAspect {
  ...
  @Around("@annotation(com.sprint.mission.discodeit.common.logging.ServiceLogAround)")
  public Object logAround(ProceedingJoinPoint joinPoint) throws Throwable {
    ...
    log.info("[end] {} | time: {}s | result: {}", fullName, stopWatch.getTotalTimeSeconds(), result);
    return result;
  }
}
